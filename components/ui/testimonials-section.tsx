...
const testimonials_en = [
  {
    text: "I entered the URL of my old site — two minutes later I had a modern website. My clients thought I hired a professional.",
    image: "https://i.pravatar.cc/80?img=11",
    name: "Klaus Bergmann",
    role: "Bergmann Heating, Munich",
  },
  {
    text: "As an electrician, I'm no web expert. Werkseite solved that completely. The new site loads fast and looks great on mobile.",
    image: "https://i.pravatar.cc/80?img=32",
    name: "Monika Schreiber",
    role: "Schreiber Electrics, Augsburg",
  },
  {
    text: "Finally a website I'm proud of. The process was so simple — enter URL, wait briefly, done. Couldn't recommend it more.",
    image: "https://i.pravatar.cc/80?img=53",
    name: "Stefan Huber",
    role: "Huber Carpentry, Rosenheim",
  },
  {
    text: "My old website was from 2012. Now I have a site that truly fits my business. New enquiries come in regularly since.",
    image: "https://i.pravatar.cc/80?img=44",
    name: "Andrea Müller",
    role: "Müller Painting, Landsberg",
  },
  {
    text: "Fast, straightforward, professional. I started in the morning and everything was done by noon. Best investment in a long time.",
    image: "https://i.pravatar.cc/80?img=15",
    name: "Thomas Bauer",
    role: "Bauer Plumbing, Freising",
  },
  {
    text: "The tool perfectly transferred our existing content and modernised it. No data loss, no effort — simply great.",
    image: "https://i.pravatar.cc/80?img=26",
    name: "Sabine Zimmermann",
    role: "Zimmermann Tiling, Ingolstadt",
  },
  {
    text: "I was sceptical, but the result convinced me. Looks like it was made by an agency — but cost nothing. Unbelievable.",
    image: "https://i.pravatar.cc/80?img=57",
    name: "Michael Gruber",
    role: "Gruber Roofing, Dachau",
  },
  {
    text: "Werkseite understood what makes my business special. The new site looks professional and authentic — exactly what I wanted.",
    image: "https://i.pravatar.cc/80?img=48",
    name: "Petra Winkler",
    role: "Winkler Interiors, Erding",
  },
  {
    text: "Super easy. Enter URL, play a quick game — and the new website is ready. I even won the game!",
    image: "https://i.pravatar.cc/80?img=19",
    name: "Felix Braun",
    role: "Braun Masonry, Wasserburg",
  },
];
...
function AnimatedCity({ cities, cityIdx }: { cities: string[]; cityIdx: number }) {
  return (
    <span
...
export function TestimonialsSection({ lang = "de" }: { lang?: Lang }) {
  ...
  const testimonials = lang === "de" ? testimonials_de : testimonials_en;
    ...
    <section className="py-24 relative overflow-hidden" style={{ background: "var(--color-surface)" }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col items-center max-w-[580px] mx-auto mb-14 text-center"
        >
          ...
          >
            {lang === "de" ? (
              <>
                {/* The entire "Handwerker/-innen in ganz [city]" phrase is whitespace-nowrap
                    so it always stays on one line and never breaks mid-city-name */}
                <span className="whitespace-nowrap">
                  Handwerker/-innen in ganz{" "}
                  <AnimatedCity cities={cities} cityIdx={cityIdx} />
                </span>{" "}
                {t.suffix}
              </>
            ) : (
